       ...
       <div class="row">
			<div class="col">
				<button class="btn btn-warning float-end"
					onclick="location.href='/theater/admin/list/1'" type="button">영화관</button>
			</div>
		</div>

		<div class="pt-5 row text-center">
			<div class="col-sm-12" align="center">
				<form action="/theater/admin/write" method="post">
					<table class="table col-sm-12">
						...
						<tr>
							...
							<td class="table-info"><label class="control-label col-sm-12"><h5>영화관전화번호</h5></label></td>
							<td><input type="text" class="form-control" id="phone" name="phone"></td>
						 


					</table>
					<button type="submit" class="btn btn-outline-info">영화관등록</button>
				</form>
